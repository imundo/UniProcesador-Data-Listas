          ...
          {emergencySearchResults.length > 0 && (
            <div className="flex flex-col gap-3 w-full">
              {emergencySearchResults.map((person, idx) => {
                ...
                const borderClass = person.cne_validado === 1 ? 'border-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.15)] bg-emerald-950/10' : 
                                    person.cne_validado === 2 ? 'border-yellow-500/50 shadow-[0_0_15px_rgba(234,179,8,0.15)] bg-yellow-950/10' : 
                                    'border-neutral-800 bg-neutral-900 hover:border-neutral-700';

                return (
                  <div key={idx} className={`rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 transition-all duration-300 border ${borderClass}`}>
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        <h4 className="text-lg font-bold text-white mr-1">{person.nombre} {person.apellido}</h4>
                        ...
                        {person.cne_validado === 2 && (
                          <span className="text-[9px] bg-yellow-500/20 text-yellow-400 px-2 py-0.5 rounded-full font-bold border border-yellow-500/30 flex items-center gap-1">
                        ...
                        {isDuplicated && (
                          <span className="text-[9px] bg-neutral-800 text-neutral-300 px-2 py-0.5 rounded-full font-bold">
                          ...
                          <td className="px-6 py-3 font-medium text-white">
                            <div className="flex flex-col items-start justify-center gap-1">
                              ...
                              <div className="flex items-center gap-1.5">
                                ...
                                {p.cne_validado === 2 && (
                                  <span className="text-[9px] uppercase font-bold tracking-wider px-1.5 py-0.5 rounded-full bg-yellow-500/20 text-yellow-400 border border-yellow-500/30 flex items-center gap-0.5" title="Similitud parcial verificada en el CNE (Observación)">
