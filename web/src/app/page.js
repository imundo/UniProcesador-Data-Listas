          ...
          {emergencySearchResults.length > 0 && (
            <div className="flex flex-col gap-3 w-full">
              {emergencySearchResults.map((person, idx) => {
                ...
                return (
                  <div key={idx} className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 hover:border-neutral-700 transition-colors relative">
                    ...
                    <a
                      ...
                      className="bg-[#25D366] hover:bg-[#20bd5a] text-white px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-colors w-full sm:w-auto justify-center sm:ml-auto mt-2 sm:mt-0"
                    >
